...
const categoryArray = categories
  ? categories.split(",").map((c) => decodeURIComponent(c))
  : [];
        // create search query
...
export const editCourse = async (req,res) => {
    ...
    await deletemedia(course.courseThumbnailPublicId);
        ...
        const updateData = {courseTitle, subTitle, description, category, courseLevel, coursePrice, courseThumbnail:courseThumbnail?.secure_url,courseThumbnailPublicId: courseThumbnail?.public_id,};
